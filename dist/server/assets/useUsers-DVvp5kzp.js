...
function getUserDashboard() {
	return baseFetchJson("/users/dashboard", { method: "GET" });
}
...
function getMyBillboardCoverage() {
	return baseFetchJson("/users/me/billboard-coverage", { method: "GET" });
}
function setMyBillboardCoverage(payload) {
	return baseFetchJson("/users/me/billboard-coverage", {
		method: "PATCH",
		body: payload
	});
}
...
function useMyBillboardCoverage() {
	return useQuery({
		queryKey: [
			"users",
			"me",
...
function useSetMyBillboardCoverage() {
	const qc = useQueryClient();
	return useMutation({

                            ...
                            <form>
                                ...
                                <div>
                                    ...
                                    <div className='flex justify-between my-5'>
                                        ...
                                        <div>
                                            <Link to="" className='text-ads360yellow-100'>Forget Password</Link>
                                        </div>
                                    </div>
                                ...
                                <p className='text-center my-5'>Dont have an account yet? <Link to="/vendors/login" className='text-ads360yellow-100'> Sign Up</Link></p>
                            </div>
...
export const Route = createFileRoute("/_access/vendors-acess/login/")({
  component: VendorsLogin,
})

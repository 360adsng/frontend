                            ...
                            <form>
                                ...
                                <div>
                                    ...
                                    <div className='text-center my-5'>
                                        <input type="checkbox" value="I agree with terms and conditions"/><span> I agree with <Link to="" className='text-ads360yellow-100'>terms and conditions</Link></span>
                                    </div>
                                    <div className='flex justify-center my-5'>
                                        <BlackButtons text='Register'/>
                                    </div>                            
                                </form>
                                <p className='text-center my-5'>Already have an account? <Link to="/vendors/login" className='text-ads360yellow-100'> Sign In</Link></p>
                            </div>
...
export const Route = createFileRoute("/_access/vendors-acess/onboarding/")({
  component: VendorsOnboarding,
})

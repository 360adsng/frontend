...
const adsgirl = "/images/adsgirl.png";
const adsgirl3 = "/images/adsgirl3.png";
    ...
    <>
      ...
      <section id="Hero" className="bg-ads360light-100 pt-20">
        <div className="flex justify-center mx-auto w-11/12 md:w-10/12 xl:w-9/12">
          <div className="">
            <div>
              <div className="md:mr-[190px] text-5xl md:text-6xl lg:text-7xl font-[600]">
                <h3>All day,</h3>
                <h3>Ad campaign </h3>
                <h3 className="text-ads360yellow-100">360...</h3>
              </div>

              <Link className="block mt-5" to="/signin">
                <BlackButtons
                  handleClick={() => {}}
                  isPending={false}
                  text="Let's dive in"
      ...
      <section id="contactus" className="bg-ads360light-100 pt-24">
        <div className="mx-auto w-11/12 md:w-10/12 xl:w-9/12">
          ...
          <div className="md:flex md:space-x-12">
            ...
            <div>
              <img src={adsgirl} className="md:h-[400px] mx-auto" alt="..." />
            </div>
          </div>
        </div>
      </section>

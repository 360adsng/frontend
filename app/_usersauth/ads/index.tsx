...
//import images
const digital = '/icons/digital.svg'
const billboard = '/icons/led2.svg'
const sms = '/icons/sms.svg'
const influencer = '/icons/influencer.svg'
const whatsapp = '/icons/whatsappCluster.svg'
          ...
          <div key={i} onClick={()=>handleRoute(ad.link)} className="cursor-pointer">
            <div className="group shadow flex rounded justify-between px-3 md:px-10 py-5 bg-white border border-ads360yellow-100 items-center">
              <div className="flex items-center">
                <img width={70} height={70} alt={ad.name} src={ad.image} />
                <div className="px-4">

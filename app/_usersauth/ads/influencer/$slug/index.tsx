...
const influencerImage2 = '/del/dav.png'
          ...
          View full details of influencer and proceed to checkout
            ...
            <section className="md:flex py-14 mx-auto w-11/12 md:w-10/12 lg:w-8/12">
              ...
              <div className="basis-1/3">
                ...
                <p className="my-3"><img alt="" src={whatsapp} className="inline w-5 h-5"/> blog:<span className="font-semibold"> 36000</span></p>
                <p className="my-3"><img alt="" src={twitter} className="inline w-5 h-5"/> Twitter: <span className="font-semibold"> 59000</span></p>
                <p className="my-3"><img alt="" src={facebook} className="inline w-5 h-5"/> Facebook: <span className="font-semibold"> 20000</span></p>

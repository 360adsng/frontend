...
const InfluencerPayoutDetailsPage = () => {
  const { id } = Route.useParams();
  const payoutId = Number(id);
  const payout = useMyPayoutById(
    payoutId,
    ...
    <section className="min-h-screen bg-ads360-hash px-4 py-14 md:px-10">
      <div className="container mx-auto">
        <div className="mb-6 flex items-start justify-between gap-3">
          ...
          <Link
            to="/vendors/influencers/payouts/"
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="rounded-10 border border-stone-200 p-4">
                ...
                <div className="mt-1 text-sm text-stone-900">
                  {payout.data.accountName} ·{" "}
                  {maskAccountNumber(payout.data.accountNumber)}
                </div>
...
export const Route = createFileRoute("/vendors/influencers/payouts/$id/")({

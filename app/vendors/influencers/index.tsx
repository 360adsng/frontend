...
/** Mirrors {@link ../billboards/index.tsx} layout and metrics for influencer vendors. */
const InfluencerVendorDashboard = () => {
  const { data: me } = useMe();
...
export const Route = createFileRoute("/vendors/influencers/")({
  component: InfluencerVendorDashboard,
});

export default InfluencerVendorDashboard;

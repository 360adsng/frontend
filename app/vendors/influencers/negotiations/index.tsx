...
import { useMyVendorNegotiatingInfluencerBookings } from "@endpoint/influencer/useInfluencer";
import { BookingsTable } from "@components/ui/BookingsTable";

const search = "/icons/search.svg";

function VendorInfluencerNegotiationsPage() {
  const [q, setQ] = useState("");
  const negotiating = useMyVendorNegotiatingInfluencerBookings();
      ...
      <div className="w-full overflow-x-auto my-5">
        <BookingsTable
          ...
          rows={rows.map((r) => ({
            ...
            status: "negotiating",
            actionHref: `/vendors/influencers/negotiations/${r.id}`,
            actionLabel: "View",
          }))}
...
export const Route = createFileRoute("/vendors/influencers/negotiations/")({

              ...
              <div className="my-3 flex items-center space-x-1">
                <div className="group relative">
                  ...
                  <div className="hidden group-hover:inline">
                    <Tooltip info="this is your incoming balance that you receive from campaigns" />
                  </div>
                </div>
...
export const Route = createFileRoute("/vendors/influencers/wallet/")({

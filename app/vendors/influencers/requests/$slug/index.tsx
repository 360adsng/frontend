...
import {
  useMarkVendorInfluencerBookingActive,
  useRejectVendorInfluencerBooking,
...
const Request = () => {
  ...
  const markActive = useMarkVendorInfluencerBookingActive();
  const rejectMutation = useRejectVendorInfluencerBooking();
          ...
          <div className="overflow-hidden rounded-2xl border border-amber-200/40 bg-white shadow-sm">
            <header className="flex flex-col gap-3 border-b border-stone-100 px-5 pt-6 pb-4 sm:flex-row sm:items-start sm:justify-between sm:px-7">
              ...
              <div className="flex flex-wrap items-center gap-2 self-end sm:self-start sm:justify-end">
                ...
                {showDisputeBanner ? (
                  <Link
                    to="/vendors/influencers/requests/$slug/dispute-chat"
            ...
            <div className="px-5 pt-5 sm:px-7">
              <h2 className="font-serif text-xl text-stone-900 md:text-2xl">
                {b.influencer?.mediaName ?? "Influencer request"}
              </h2>
...
export const Route = createFileRoute("/vendors/influencers/requests/$slug/")({
  component: Request,
});

...
const Arrowright = '/icons/Arrowright.svg'
            ...
            >
...

                {
                    items.map((values, i)=>(
                        ...
                        <SwiperSlide key={i}>
                            <div className='flex mb-4 justify-center'><span className='flex items-center pr-3'><img src={Yellowdot} alt=''/></span>{values.name}</div>
                            <div className=''>
                                ...
                                <div className=''>
                                    <div>
                                        ...
                                        <Link to={values.link} className={`${display} my-5`}><YellowButtons text='Learn More'/></Link>
                                        </div>
                                    </div>
                                </div>
                        </SwiperSlide> 

          ...
          return (
            <li key={i}>
              {active ? (
                ...
                >
                  <img src={items.on} alt={items.name} />
                ...
                <Link to={items.link} className="py-2 px-4 flex">
                  <img src={items.off} alt={items.name} />
            ...
            <li key={i}>
              {"kind" in items && items.kind === "help" ? (
                active ? (
                  <Link
                    to={items.link}
                    className="border-l-2 border-ads360yellow-100 bg-[#322f31] rounded-r-[200px] py-2 px-4 flex items-center"
                  >
                    <FiHelpCircle className="h-6 w-6 shrink-0 text-ads360yellow-100" aria-hidden />
                    <span className="hidden group-hover:block text-ads360yellow-100 px-2 xl:px-4 hover:font-bold">
                      {items.name}
                    </span>
                  </Link>
                  ...
                  <Link to={items.link} className="py-2 px-4 flex items-center">
                    <FiHelpCircle className="h-6 w-6 shrink-0 text-white" aria-hidden />
                    <span className="hidden group-hover:block px-2 xl:px-4 hover:font-bold">
                      {items.name}
                    </span>
                  </Link>
...
export default InfluencerSideNav;
